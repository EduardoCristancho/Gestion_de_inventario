...
export default function BottomNavbar() {
  ...
  return (
    <div className="fixed md:max-w-50  md:flex md:flex-col md:justify-center md:max-h-[calc(100vh-56px)] md:h-[calc(100dvh-56px)] bottom-0 left-0 z-50 w-full h-16 bg-quaternary border-t border-gray-200 shadow-lg">
